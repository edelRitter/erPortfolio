    ...
    <div class="row no-gutters">
      ...
      <div class="col-12 col-md-6">
        <div class="portfolio-about__profile">
          ...
          <div
            class="portfolio-about__profile-picture"
            data-aos="fade"
            data-aos-duration="800"
            data-aos-delay="800"
            data-aos-once="true"
          ...
          <ul class="d-flex m-0 p-0">
            <li class="portfolio-about__profile-list"><strong>arknights :</strong> The music and characters are phenomenal. Developed by Hypergryph</li>
            <li class="portfolio-about__profile-list"><b>music :</b> Eli Noir, M2U, hybrid, Siames, AJURIKA, Caravan Palace, nujabes, Masashi Hamauzu, Adam Gubman, Nomak, Starset, etc.</li>
          </ul>
          <ul class="d-flex m-0 p-0">
            <li class="portfolio-about__profile-list"><b>games :</b> Omori, Chrono Trigger, Saga Frontier 2, SF 3rd Strike, Cytus 2, Final Fantasy 6/7/9, Smash bros melee, Lord of Vermilion 2, etc.</li>
            <li class="portfolio-about__profile-list"><b>film :</b> Blade Runner, Truman Show, Punch Drunk Love, The Grand Budapest Hotel, The Godfather 1/2, The Matrix, Dunkirk, Parasite, Lawrence of Arabia, Memento, Birdman, etc.</li>
          </ul>
          <div 
